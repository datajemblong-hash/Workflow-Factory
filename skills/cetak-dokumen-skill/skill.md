...
23. **(Universal)** Buat direktori `skills/git-rollback-skill/` dan salin isi file dari `i:\Workflow-Factory\skills\git-rollback-skill\skill.md`.
...
36. Setelah semua eksekusi berhasil, laporkan di panel chat:
    ...
    🧰 Skills: log, git, review-kode, deployment, testing, git-workflow, security-audit, sprint-update, backup, env-setup, readme-generator, error-solver, prompt-helper, git-rollback [+dokumentasi-api] [+database-schema]
